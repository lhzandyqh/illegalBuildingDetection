...
export const asyncRoutes = [
  ...
  },
  {
    ...
    children: [
      {
        path: 'buildingMonitor',
        component: () => import('@/views/detection/illeBuildingDetection'),
        // component: () => import('@/views/detection/test'),
        name: 'BuildingMonitor',
        meta: { title: '违章建筑识别', noCache: true }
      }
    ]
  },
  {
    ...
    children: [
      {
        path: 'index',
        component: () => import('@/views/inspectionCenter/index'),
        name: 'ducha',
        meta: { title: '督查中心', icon: 'tab', noCache: true }
      }
    ]
  },
  {
